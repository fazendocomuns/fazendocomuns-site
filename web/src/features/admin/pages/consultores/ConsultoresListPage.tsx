...
import { useConsultores, useConsultorMutations } from '@/features/admin/api/equipe'
...
export function ConsultoresListPage() {
  ...
  const { remove, reorder, toggleStatus } = useConsultorMutations()
    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          onAction={() => router.push('/admin/consultores/novo')}
        />
      ) : (
