...
import { usePesquisadores, usePesquisadorMutations } from '@/features/admin/api/equipe'
import { usePaginatedList } from '@/features/admin/hooks/usePaginatedList'

export function PesquisadoresListPage() {
  const router = useRouter()
  const { data: pesquisadores = [], isLoading } = usePesquisadores()
  const { remove, reorder, toggleStatus } = usePesquisadorMutations()
    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          onAction={() => router.push('/admin/pesquisadores/novo')}
        />
      ) : (
